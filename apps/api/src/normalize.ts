...
const CATEGORY_KEYWORDS: Array<[string, RegExp]> = [
  ...
  ["arts", /designer|graphiste|artiste|photograph|videast|vidéast|monteur vid|monteuse vid|montage vid|createu|créateu|illustrateu|musique|scenograph|graphic|artist|videographer|illustrator/i],
  ...
  ["direction", /directeu|directrice|vice-president|vice-président|chef de (?:service|departement|département)|gestionnaire|president|président|pdg|dg\b|chef d'equipe|chef d'équipe|\bmanager\b|\bdirector\b|supervisor|management trainee|team lead|\bchief\b|head of|executive|charg\S* de projet|chef de projet|gestion de projet/i],
];
